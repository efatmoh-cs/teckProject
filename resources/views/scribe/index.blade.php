...
<div class="bash-example">
    ...
    \"phone\": \"qxbajwbpilpmu\",
    \"email\": \"haley.isabel@example.org\",
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="haley.isabel@example.org"
               data-component="body">
    <br>
<p>Must be a valid email address. Must not be greater than 255 characters. Example: <code>haley.isabel@example.org</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               value="IV#lz.KcLcDi`wmUB)z"
               data-component="body">
    <br>
<p>Must be at least 8 characters. Example: <code>IV#lz.KcLcDi</code>wmUB)z`</p>
        </div>
        </form>
